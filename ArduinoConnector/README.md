...
| ALT_CALIBR_HUNDREDS_ZERO     |     0x41 | in steps (stepper)                    |
| ALT_CALIBR_THOUSANDS_ZERO    |     0x42 | in steps (stepper)                    |
| ALT_CALIBR_TENTHOUSANDS_ZERO |     0x43 | in steps (stepper)                    |
...
| AI_PITCH_CALIBR_20ZERO       |     0x61 | in steps (stepper)                    |
| AI_PITCH_CALIBR_20UP         |     0x62 | in steps (stepper)                    |
| AI_PITCH_CALIBR_20DOWN       |     0x63 | in steps (stepper)                    |
| AI_ROL                       |     0x64 | attitude roll (degrees)               |
| AI_ROL_CALIBR_20ZERO         |     0x65 | in steps (stepper)                    |
| AI_ROL_CALIBR_20LEFT         |     0x66 | in steps (stepper)                    |
| AI_ROL_CALIBR_20RIGHT        |     0x67 | in steps (stepper)                    |
